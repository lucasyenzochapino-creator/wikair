...
const funFacts = [
  { wiki: "Airbus A350 XWB", title: "El vuelo más largo del mundo", desc: "Singapore Airlines vuela Singapore–Nueva York en el A350-900ULR. Son 18 horas y 50 minutos y 15.349 km sin escala." },
  { wiki: "Boeing 737", title: "El rayo que no para", desc: "Un Boeing 737 es alcanzado por un rayo en promedio una vez por año. El fuselaje metálico conduce la electricidad y protege a los pasajeros." },
  { wiki: "Air traffic control", title: "Tráfico aéreo mundial", desc: "En un día normal hay más de 100.000 vuelos en el mundo. En el momento pico, hay 15.000+ aviones simultáneamente en el aire." },
  { wiki: "Boeing 747", title: "Millones de partes", desc: "Un Boeing 747 tiene 6 millones de partes individuales. Si se pusieran en línea una tras otra, ocuparían 100 km." },
  { wiki: "Aviation safety", title: "La estadística más tranquilizadora", desc: "Volar es 95 veces más seguro que manejar un auto. La probabilidad de morir en un avión comercial es de 1 en 11 millones." },
  { wiki: "Airbus H125", title: "El Everest en helicóptero", desc: "En 2005, el piloto Didier Delsalle aterrizó un Airbus H125 en la cima del Everest a 8.848 m. Permaneció 3 minutos 50 segundos." },
];

type Tab = "todos" | "velocidad" | "tamano" | "produccion" | "altitud" | "historicos" | "curiosidades";
...
export default function RecordsPage() {
  ...
  const show = (tab: Tab) => activeTab === "todos" || activeTab === tab;
    ...
    <main className="page">
      ...
      <nav className="categoryNav">
        <div className="categoryNavInner">
          {tabs.map((t) => (
            <button
              key={t.id}
              className={activeTab === t.id ? "tabActive" : "tabButton"}
      ...
      {show("velocidad") && (
        <section className="container" style={{ paddingTop: 40, paddingBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 5vw, 44px)", margin: "8px 0 24px", letterSpacing: -1 }}>Velocidad máxima</h2>
      ...
      {show("tamano") && (
        <section className="container" style={{ paddingBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 5vw, 44px)", margin: "8px 0 24px", letterSpacing: -1 }}>Dimensiones extremas</h2>
          <div className="statsGrid">
      ...
      {show("produccion") && (
        <section className="container" style={{ paddingBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 5vw, 44px)", margin: "8px 0 24px", letterSpacing: -1 }}>De las fábricas al cielo</h2>
          <div className="statsGrid">
      ...
      {show("altitud") && (
        <section className="container" style={{ paddingBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 5vw, 44px)", margin: "8px 0 24px", letterSpacing: -1 }}>Más cerca del espacio</h2>
          <div className="statsGrid">
      ...
      {show("historicos") && (
        <section className="container" style={{ paddingBottom: 48 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 5vw, 44px)", margin: "8px 0 24px", letterSpacing: -1 }}>Que cambiaron el mundo</h2>
          <div className="statsGrid">
      ...
      {show("curiosidades") && (
        <section className="container" style={{ paddingBottom: 60 }}>
          ...
          <h2 style={{ fontSize: "clamp(26px, 5vw, 44px)", margin: "8px 0 24px", letterSpacing: -1 }}>Datos que te van a volar la cabeza</h2>
          <div className="statsGrid">
            {funFacts.map((f) => (
